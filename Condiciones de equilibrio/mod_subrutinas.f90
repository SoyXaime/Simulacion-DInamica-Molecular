...
contains
    ...
    !$omp& private(i,j,dx,dy,dz,r2,invr2,sr2,sr6,sr12,v_ij,fmod,fx,fy,fz) &
    !$omp& reduction(+:Ep_local) schedule(static)
    ...
    subroutine verlet(rx,ry,rz,vx,vy,vz,ax,ay,az,Ep,Ec)
